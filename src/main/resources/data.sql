...
FROM cargo c,
     setor s
WHERE c.nome_cargo = 'Desenvolvedor'
  AND s.nome_setor = 'Tecnologia'
...
FROM cargo c,
     setor s
WHERE c.nome_cargo = 'Gerente de Projeto'
  AND s.nome_setor = 'Marketing'
...
SELECT 'Desenvolver sistema de login',
...
INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Criar landing page',
       'Desenvolver pagina inicial responsiva',
       'A_INICIAR',
       0.0,
       '2024-02-01',
       '2024-02-28',
...
INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Campanha redes sociais',
       'Planejar campanha no Instagram e Facebook',
       'EM_ANDAMENTO',
       30.0,
       '2024-01-20',
       '2024-03-01',
       ...
       'ALTA'
FROM espaco
WHERE nome = 'Marketing Digital'
  AND NOT EXISTS (SELECT 1 FROM tarefa WHERE titulo = 'Campanha redes sociais');

INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Processo seletivo',
       'Recrutar desenvolvedores senior',
       'EM_ATRASO',
       15.0,
       '2024-01-01',
       '2024-01-31',
...
INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Analise de vendas Q1',
       'Relatorio de vendas do primeiro trimestre',
       'CONCLUIDO',
       100.0,
       '2024-01-01',
       '2024-01-30',
...
INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Redesign do produto',
       'Atualizar interface do usuario',
       'A_INICIAR',
       0.0,
       '2024-02-15',
       '2024-04-15',
...
INSERT INTO tarefa (titulo, descricao, status, progresso, data_inicio, data_entrega, espaco_id, prioridade)
SELECT 'Sistema de notificacoes',
...
FROM tarefa t,
     usuario u
WHERE t.titulo = 'Desenvolver sistema de login'
  AND u.email = 'joao@techcorp.com'
...
FROM tarefa t,
     usuario u
WHERE t.titulo = 'Campanha redes sociais'
  AND u.email = 'pedro@innovatech.com'
...
FROM tarefa t,
     usuario u
WHERE t.titulo = 'Analise de vendas Q1'
  AND u.email = 'joao@techcorp.com'
